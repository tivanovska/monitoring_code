...
#include "../../../src/imagelistener/include/qnode.hpp"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QNode_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 19, 12)
    ...
    "QNode\0rosShutdown\0\0imageUpdated\0"
};
...
void QNode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QNode::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QNode::imageUpdated)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject QNode::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_QNode.data,
      qt_meta_data_QNode,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNode.stringdata))
